...
// https://github.com/craftyjs/Crafty/blob/f4a79d79c2fe31375e3818ed43d501f100641f5f/build/api-gen/dynamic-server.js
...
function startServer(grunt, input) {
  ...
  function createPage(selector, filename) {
    ...
    raw = "<head><title>" + title + "</title>" + " <link type='text/css' rel='stylesheet' href='http://craftyjs.com/craftyjs-site.css'/>" + " <link type='text/css' rel='stylesheet' href='http://craftyjs.com/github.css'/>" + " <link type='text/css' rel='stylesheet' href='dev.css' />" + "</head>" + "<body><div id='main'><div id='content' class='container'>" + raw + "</div></div></body>";
    return raw;
  }
