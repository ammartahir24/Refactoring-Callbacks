// file taken from https://github.com/jshttp/compressible/blob/master/test/test.js
var assert = require('assert');

var db = require('mime-db');

var compressible = require('../'); // None of these should be actual types so that the lookup will never include them.
...
var EXAMPLE_TYPES = [{
  ...
  type: 'something/frog+TEXT',
  should: true
}, {
  type: 'type/json;askjkl+json',
  should: undefined
}, {
  type: 'type/+json',
  should: true
}, {
  type: 'data/beans+xml ; charset="utf-8"',
  should: true
}, {
  type: 'can/worms+xml;blaaaah',
  should: true
}, {
  type: 'data/xml',
  should: undefined
