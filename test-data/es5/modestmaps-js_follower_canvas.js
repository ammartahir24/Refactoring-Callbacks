...
(function (MM) {
  MM.Follower = function (map, location, content) {
    ...
    var callback = function callback(m, a) {
      return follower.draw(m);
    };
    ...
    this.div.style.height = this.dimensions.y + 'px'; //this.div.style.backgroundColor = 'white';
  ...
  MM.Follower.prototype = {
    ...
    drawBubblePath: function drawBubblePath(ctx) {
      ctx.beginPath();
