// file taken from https://github.com/npm/cli/blob/latest/node_modules/lockfile/lockfile.js
var fs = require('fs');
...
exports.unlock = function (path, cb) {
  debug('unlock', path); // best-effort.  unlocking an already-unlocked lock is a noop
...
exports.unlockSync = function (path) {
  debug('unlockSync', path); // best-effort.  unlocking an already-unlocked lock is a noop
...
exports.lock = function (path, opts, cb) {
  ...
  fs.open(path, wx, function (er, fd) {
    ...
    debug('failed to acquire lock', er); // something other than "currently locked"
...
function notStale(er, path, opts, cb) {
  debug('notStale', path, opts); // if we can't wait, then just call it a failure
