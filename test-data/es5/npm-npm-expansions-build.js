// file taken from https://github.com/npm/npm-expansions/blob/master/build.js
var fs = require("fs");
...
fs.writeFileSync(outfile_txt, list.reduce(function (p, c) {
  return p + c + '\n';
}, list.shift() + '\n')); // reappend the instructions

fs.appendFileSync(outfile_txt, "#\n" + "# please don't add your expansions down here!\n" + "# insert them in alphabetical order to help reduce merge conflicts.\n" + "#\n" + "# <3\n");