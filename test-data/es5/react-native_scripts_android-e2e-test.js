//https://github.com/facebook/react-native/blob/master/scripts/android-e2e-test.js
...
describe('Android Test App', function () {
  ...
  it('should have the menu available', function () {
    return driver.waitForElementByXPath('//android.widget.TextView[starts-with(@text, "Welcome to React")]') // http://developer.android.com/reference/android/view/KeyEvent.html#KEYCODE_MENU
    .pressDeviceKey(82).waitForElementByXPath('//android.widget.TextView[starts-with(@text, "Toggle Inspector")]');
  });
});